...
def evaluate_extracted_concept(actual_concepts, extracted_concepts):
...
# def compute_true_positive_score(extracted_concepts, actual_concepts):
#     """
#     Returns 1 if exact match, 0.5 if any extracted concept is a substring of any actual concept, else 0.
#     """
#     for concept in extracted_concepts:
#         if concept in actual_concepts:
#             return 1
#         for actual in actual_concepts:
#             # Doesn't count twice even if it is the substring of another concept.
#             if concept in actual:
#                 return 0.5
#     return 0
