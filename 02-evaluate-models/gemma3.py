...
for i, row in enumerate(dataset):
    ...
    for concept, reasoning_questions in multiconcept_reasoning_questions.items():
        ...
        reasoning_questions_and_answers[concept] = {
            "positive_accuracy": positive_accuracy / len(yes_questions) if yes_questions else 0,
            "negative_accuracy": negative_accuracy / len(no_questions) if no_questions else 0,
